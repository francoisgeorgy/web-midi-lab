...
function ADSR() {
    ...
    this.process = function () {
        switch (this.state) {
            ...
            case this.envState.env_release:
                console.log('this.releaseCoef', this.releaseCoef);
    ...
    this.gate = function (gate) {
        if (gate > 0) {
            // console.log('gate', gate, this.state, this.envState);
        ...
        // console.log('gate exit', gate, this.state, this.envState);
    }
